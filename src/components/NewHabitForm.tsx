...
export const NewHabitForm = () => {
	return (
		<form className="w-full flex flex-col mt-6">
			...
			<input type="text" id="title" placeholder="ex.: Exercícios, estudar, etc..." className="p-4 rounded-lg mt-3 bg-zinc-800 text-white placeholder:text-zinc-400" autoFocus />
