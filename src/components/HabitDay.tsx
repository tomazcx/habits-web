...
export const HabitDay = ({date, defaultCompleted = 0, amount = 0}: IHabitDay) => {
	...
	return (
		<Popover.Root>
			...
			<Popover.Trigger className={clsx('w-10 transition-colors  focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background border-2 h-10  rounded-lg', {
