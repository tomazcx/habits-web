...
export const HabitDay = ({date, completed = 0, amount = 0}: IHabitDay) => {
	...
	return (
		<Popover.Root>
			...
			<Popover.Trigger className={clsx('w-10 border-2 h-10  rounded-lg', {
			...
			<Popover.Portal>
				<Popover.Content className="min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col">
					...
					<div className="mt-6 flex flex-col gap-3">
						<CheckboxHabit label="Beber dois litros de água" />
					</div>
